...
// Meme logique que CommerceRenewModal.tsx, appliquee au TLPE.
export default function TlpeRenewModal({ isOpen, onClose, onSuccess, tiersId, currentYear, occupations }: Props) {
  ...
  const handleRenew = async () => {
    ...
    setLoading(true);
    try {
      await axios.post(`/api/tlpe/${tiersId}/renew`, {
          ...
          <div>
            <h3 className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-2">
              ...
              <input
                ...
                className="w-24 px-2 py-1 text-xl font-black bg-white border border-slate-200 rounded-lg text-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </h3>
                        ...
                        <div className="flex items-center justify-between gap-4">
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-500 mt-1">
                              Surface: {ligne.quantite1} m² &middot; {ligne.montant}&nbsp;€/m²
                            </p>
                            {!isSelectable && (
                          ...
                          {isSelectable && (
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${
                              selectedDevices.includes(ligne.id) ? 'bg-purple-600 text-white' : 'bg-slate-200'
                            }`}>

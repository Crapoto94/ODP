...
export default function UploadDocModal({ isOpen, onClose, onUpload, isUploading }: Props) {
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="Ex: Demande de chantier, Plan de situation..."
            ...
            <div className={`relative group transition-all ${file ? 'border-emerald-200 bg-emerald-50' : 'border-slate-200 bg-slate-50 hover:border-blue-200 hover:bg-blue-50/30'} border-2 border-dashed rounded-[1.5rem] p-8 text-center`}>
              ...
              <div className="flex flex-col items-center">
                ...
                {file ? (
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Cliquez ou glissez un PDF/Image</p>
                )}
              </div>
            </div>
          </div>
